...
HD_PWD='C:/Users/liben002/Downloads/ec311/whack_a_mole/src/whack_a_mole/whack_a_mole.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log whack_a_mole_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source whack_a_mole_top.tcl
